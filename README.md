...
- **MoE bottleneck**: differentiable routing of spatial tokens across multiple expert FFNs; configurable number of experts, placement mode (conservative / full), and optional axial positional embeddings.
